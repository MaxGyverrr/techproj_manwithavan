                ...
                <div class="panel-body">
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            <h3 style="color: black; margin:0%;">About Us</h3><span class="glyphicon glyphicon-road"></span>
                        </div>
                    </div>
                            ...
                            <div class="row" style="padding: 60px 0px 60px">
                                <div class="col-md-8 col-md-offset-2 text-center">
                                    <span style="font-size: 23px;">
                                        At the moment, we have three vehicles of different sizes, two vans for small services and one mini-truck for larger services!
                                    </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6">
                            <img class="img-thumbnail img-responsive img-portfolio img-hover" src="images/Van_5.jpeg" alt="">
                        </div>

                        <div class="col-md-6 col-sm-6">
                            <img class="img-thumbnail img-responsive img-portfolio img-hover" src="images/Van_6.jpeg" alt="">
                        </div>
                    </div>
